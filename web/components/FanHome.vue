...
const displayMex = computed(() => {
    if (!mex.value) {
        return '$0.00'
    }

    return numeral(mex.value).format('$0.00')
})
            ...
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="javascript://" class="-m-1.5 p-1.5">
                        ...
                        <img class="h-12 w-auto" src="~/assets/fan.png" alt="" />
                    </a>
                </div>
                ...
                <div class="hidden lg:flex lg:gap-x-20">
                    <NuxtLink to="https://nexa.org" target="_blank" class="text-2xl font-medium leading-6 text-gray-500 hover:text-blue-500">
                        NEXA.org
                    </NuxtLink>

                    <NuxtLink to="https://awesomenexa.org" target="_blank" class="text-2xl font-medium leading-6 text-gray-500 hover:text-blue-500">
                        AwesomeNexa.org
                    </NuxtLink>
                </div>

                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <small class="-mt-1 pr-2 text-gray-400 text-right">
                        mNEXA
                        <br />/ USD
                    </small>

                    <NuxtLink to="https://nexa.exchange/markets" target="_blank" class="text-4xl font-medium leading-6 text-gray-900">
                        {{displayMex}}
                    </NuxtLink>
                </div>
            </nav>
            ...
            <div v-if="isShowingMenu" class="lg:hidden" role="dialog" aria-modal="true">
                ...
                <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                    <div class="flex items-center justify-between">
                        <a href="javascript://" class="-m-1.5 p-1.5">
                            <span class="sr-only">Your Company</span>
                            <img class="h-8 w-auto" src="~/assets/fan.png" alt="" />
                        </a>
                ...
                <div class="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
                    ...
                    <div class="w-full lg:max-w-xl lg:flex-auto">
                        ...
                        <div class="mt-8 flex border-t border-gray-100 pt-8">
                            <a href="javascript://" class="text-sm font-semibold leading-6 text-indigo-600 hover:text-indigo-500">View all openings <span aria-hidden="true">&rarr;</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="border-t border-gray-900/10 pt-20 xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div class="mt-10 xl:mt-0">
                        <h3 class="text-lg font-semibold leading-6 text-gray-900">
                            AwesomeNexa Newsletter
                        </h3>

                        <p class="mt-2 text-sm leading-6 text-gray-600">
                            Receive the latest Nexa news, articles, and resources, sent to your inbox weekly.
                        </p>
