...
useHead({
    title: `$SHELL — NexaShell`,
    meta: [
        { name: 'description', content: `Investors burn $SHELL to pay exchange fees and/or stake $SHELL to activate premium tools & services, featuring: real-time market insights, exclusive alpha metrics & security assessments, plus priority access to Ava's world-class support team.` }
    ],
})
                ...
                <div class="mx-auto max-w-7xl px-6 pb-16 pt-16 sm:pt-32 lg:px-8 lg:pt-16">
                    <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                            ...
                            <p class="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                                Investors burn $SHELL to pay exchange fees and/or stake $SHELL to activate premium tools & services, featuring: real-time market insights, exclusive alpha metrics & security assessments, plus priority access to Ava's world-class support team.
                            </p>
